 ...
 *
 * The sheet unavoidably covers the middle of the hand at this height — there is
 * no arrangement that fits both — so the cards either side of it are what the
 * player can still reach, and these tests hold that much in place.
 */
